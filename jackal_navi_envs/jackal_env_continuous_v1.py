...
class JackalEnvContinuous(gym.Env):
    ...
    def __init__(self, world_name = 'sequential_applr_testbe.world', VLP16 = 'false', gui = 'false', camera = 'false',
                ...
                param_delta = [0.2, 0.3, 1, 2, 0.02, 0.2, 0.2, 0.05], param_init = [0.5, 1.57, 6, 20, 0.1, 0.75, 1, 0.3],
                param_list = ['max_vel_x', 'max_vel_theta', 'vx_samples', 'vtheta_samples', 'occdist_scale', 'path_distance_bias', 'goal_distance_bias'],
                ):
        """
